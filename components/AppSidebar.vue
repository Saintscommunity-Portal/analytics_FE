      ...
      >
        <div v-if="item.children" class="space-y-1">
          <div
            ...
            :class="isGroupActive(item) ? 'bg-[#a83632]/5 text-[#a83632] dark:bg-[#a83632]/10 dark:text-[#f2b3af]' : 'text-gray-600 dark:text-gray-300'"
          >
            <i :class="[item.icon, 'text-base']" />
            <span v-if="!collapsed" class="truncate">{{ item.label }}</span>
          </div>

          <div v-if="!collapsed" class="ml-5 space-y-1 border-l border-gray-200 pl-3 dark:border-gray-800">
            <NuxtLink
